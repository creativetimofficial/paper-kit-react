...
<title>
 Forms - Paper Kit by Creative Tim 
</title>
...
<Label check>
<Input defaultValue="option1" id="exampleRadiosInline1" name="exampleRadiosInline" type="radio">
</Input>
 1 <span className=" form-check-sign">
</span>
</Label>
...
<div className=" form-check-radio form-check-inline">
<Label check>
<Input defaultChecked defaultValue="option2" id="exampleRadiosInline2" name="exampleRadiosInline" type="radio">
</Input>
 2 <span className=" form-check-sign">
</span>
</Label>
...
<Label check>
<Input defaultValue="option3" disabled id="exampleRadiosInline3" name="exampleRadiosInline" type="radio">
</Input>
 3 <span className=" form-check-sign">
</span>
</Label>
