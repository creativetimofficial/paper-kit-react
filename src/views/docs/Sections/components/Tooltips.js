...
<title>
 Tooltips - Paper Kit by Creative Tim 
</title>
...
<p className=" muted">
Tight pants next level keffiyeh <a href="#pablo" id="tooltip771566719" onClick={e =>
 e.preventDefault()}>
you probably
</a>
<UncontrolledTooltip delay={0} target="tooltip771566719">
Default tooltip
</UncontrolledTooltip>
 haven't heard of them. Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeney's fixie sustainable quinoa 8-bit american apparel <a href="#pablo" id="tooltip962688388" onClick={e =>
 e.preventDefault()}>
have a
</a>
<UncontrolledTooltip delay={0} target="tooltip962688388">
Another tooltip
</UncontrolledTooltip>
 terry richardson vinyl chambray. Beard stumptown, cardigans banh mi lomo thundercats. Tofu biodiesel williamsburg marfa, four loko mcsweeney's cleanse vegan chambray. A really ironic artisan <a href="#pablo" id="tooltip278118192" onClick={e =>
 e.preventDefault()}>
whatever keytar
</a>
<UncontrolledTooltip delay={0} target="tooltip278118192">
Another one here too
</UncontrolledTooltip>
, scenester farm-to-table banksy Austin <a href="#pablo" id="tooltip782014484" onClick={e =>
 e.preventDefault()}>
twitter handle
</a>
<UncontrolledTooltip delay={0} target="tooltip782014484">
The last tip!
</UncontrolledTooltip>
...
<Button color="secondary" data-placement="top" id="tooltip59698453" type="button">
Tooltip on top
</Button>
<UncontrolledTooltip delay={0} placement="top" target="tooltip59698453">
Tooltip on top
</UncontrolledTooltip>
<Button color="secondary" data-placement="right" id="tooltip526202628" type="button">
Tooltip on right
</Button>
<UncontrolledTooltip delay={0} placement="right" target="tooltip526202628">
Tooltip on right
</UncontrolledTooltip>
<Button color="secondary" data-placement="bottom" id="tooltip835987786" type="button">
Tooltip on bottom
</Button>
<UncontrolledTooltip delay={0} placement="bottom" target="tooltip835987786">
Tooltip on bottom
</UncontrolledTooltip>
<Button color="secondary" data-placement="left" id="tooltip632602936" type="button">
Tooltip on left
</Button>
<UncontrolledTooltip delay={0} placement="left" target="tooltip632602936">
Tooltip on left
</UncontrolledTooltip>
<Button color="secondary" data-html={true} id="tooltip223467496" type="button">
Tooltip with HTML
</Button>
<UncontrolledTooltip delay={0} target="tooltip223467496">
...
<p>
If you want to see more examples and properties please check the official <a href="https://getbootstrap.com/docs/4.3/components/tooltips/">
