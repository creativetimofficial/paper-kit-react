...
<title>
 Bootstrap Switch v3.3.2 - Paper Kit by Creative Tim 
</title>
...
<div className=" bd-example" data-example-id="">
 {/* markup */}
 <label>
<input data-off-color="primary" data-on-color="primary" data-toggle="switch" defaultChecked type="checkbox">
</input>
...
<label>
<input data-off-color="primary" data-on-color="primary" data-toggle="switch" type="checkbox">
</input>
<span className=" toggle">
</span>
</label>
